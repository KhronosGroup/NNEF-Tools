...
def main():
    try:
        ...
        version = "nnef_to_tf: nnef_converters {}".format(version)
    except ImportError:
        version = "unknown"

    parser = argparse.ArgumentParser(description="NNEF to Tensorflow (source) converter")
    ...
    parser.add_argument("-v", "--verbose", action="store_true",
                        help="print debug info to the console and the resulting Python file")
    ...
    from nnef_converters.tf_converters.nnef_to_tf import convert
