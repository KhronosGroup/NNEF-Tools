...
# source: nnef_tools/io/onnx/onnx_pb/onnx.proto
...
AttributeProto = _reflection.GeneratedProtocolMessageType('AttributeProto', (_message.Message,), dict(
  ...
  __module__ = 'nnef_tools.io.onnx.onnx_pb.onnx_pb2'
