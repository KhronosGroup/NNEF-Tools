...
_MEMORYSTATS.fields_by_name['device_temp_memory_size'].has_options = True
_MEMORYSTATS.fields_by_name['device_temp_memory_size']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_MEMORYSTATS.fields_by_name['device_persistent_memory_size'].has_options = True
_MEMORYSTATS.fields_by_name['device_persistent_memory_size']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_MEMORYSTATS.fields_by_name['device_persistent_tensor_alloc_ids'].has_options = True
_MEMORYSTATS.fields_by_name['device_persistent_tensor_alloc_ids']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
